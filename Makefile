...
CLANG_FLAGS = -Wall -O2 -ffreestanding -nostdinc -nostdlib -mcpu=cortex-a53+nosimd
...
run: kernel8.img
	qemu-system-aarch64 -M raspi3b -kernel kernel8.img -d in_asm -serial null -serial stdio
